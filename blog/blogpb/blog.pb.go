...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x22, 0x33,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x32, 0x50,
...
var file_blog_blogpb_blog_proto_goTypes = []interface{}{
	...
	(*Blog)(nil),               // 2: blog.Blog
}
var file_blog_blogpb_blog_proto_depIdxs = []int32{
	2, // 0: blog.CreateBlogRequest.blog:type_name -> blog.Blog
	2, // 1: blog.CreateBlogResponse.blog:type_name -> blog.Blog
	0, // 2: blog.BlogService.CreateBlog:input_type -> blog.CreateBlogRequest
	1, // 3: blog.BlogService.CreateBlog:output_type -> blog.CreateBlogResponse
