...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x46, 0x0a, 0x08, 0x47, 0x72, 0x65, 0x65,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	2,  // 0: greet.GreetRequest.greeting:type_name -> greet.Greeting
	2,  // 1: greet.GreetManyTimesRequest.greeting:type_name -> greet.Greeting
	2,  // 2: greet.LongGreetRequest.greeting:type_name -> greet.Greeting
	2,  // 3: greet.GreetEveryoneRequest.greeting:type_name -> greet.Greeting
	2,  // 4: greet.GreetWithDeadlineRequest.greeting:type_name -> greet.Greeting
	0,  // 5: greet.GreetService.Greet:input_type -> greet.GreetRequest
